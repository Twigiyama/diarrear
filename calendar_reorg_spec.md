...
- **Tier 1 (CEO / Exec):** Default to `45 minutes` or `1 hour`.
- **Tier 2 (Direct Reports):** Default to `45 minutes` or `1 hour`.
...
| :--- | :--- | :--- |
| **Tier 1 (Highest)** | • **Todd Latham** (CEO & Manager)<br>• **Alyssa Stringer** (Head of Product)<br>• **Sam Park**<br>• *Meetings:* Exec Team meetings, Engineering & Product Leadership Meetings, Company All Hands, Product & Engineering All Hands | Never decline. Move other conflicting events. Can reschedule/shift Deep Work blocks if absolutely necessary. |
...
| **Tier 3** | • Dept Heads (e.g., **Rebecca Batley** - Head of People) | Flexible. Reschedule to next week or delegate/decline if conflicts cannot be resolved. |
